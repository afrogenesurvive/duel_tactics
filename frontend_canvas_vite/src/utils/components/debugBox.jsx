  ...
  return (
    <div className="debugBoxContainer">
      {state === "player" && (
        <ul className="debugBoxList">
          ...
          <li className="debugBoxListItem">
            ...
            <p className="debugBoxText">{props.player.hp}</p>
          </li>
          ...
          <li className="debugBoxListItem">
            ...
            <p className="debugBoxText">{props.player.speed.move}</p>
          </li>
          ...
          {props.player.statusDisplay.state === true && (
            <li className="debugBoxListItem">
              <p className="debugBoxText">{props.player.statusDisplay.status}</p>
            </li>
          )}
          ...
          <li className="debugBoxListItem">
            <a onClick={() => handleStateChange("gear", props.player.number)}>
              <OverlayTrigger
                placement={"bottom"}
                overlay={
                  <Popover id={`popover-positioned-${"bottom"}`}>
          ...
          <li className="debugBoxListItem">
            <a onClick={() => handleStateChange("crits", props.player.number)}>
              <OverlayTrigger
                placement={"bottom"}
                overlay={
                  <Popover id={`popover-positioned-${"bottom"}`}>
      ...
      )}
      {
        ...
        //   }
        //   <li className="debugBoxListItem">
        //   <a onClick={()=>handleStateChange('gear')}>
      ...
      {state === "crits" && (
        <div>
          ...
          <ul className="debugBoxList">
            <li className="debugBoxListItem">
              <p className="debugBoxText">1 Damage: {singleHitCrit} %</p>
            </li>
            <li className="debugBoxListItem">
              <p className="debugBoxText">2 Damage: {doubleHitCrit} %</p>
            </li>
            <li className="debugBoxListItem">
            ...
            <li className="debugBoxListItem">
              <p className="debugBoxText">Defend Deflect: {guardBreakCrit} %</p>
            </li>
            <li className="debugBoxListItem">
              <p className="debugBoxText">Attack Deflect: 50 %</p>
            </li>
            <li className="debugBoxListItem">
              <p className="debugBoxText">Attack Pushback: {attackPushBackCrit} %</p>
            </li>
            <li className="debugBoxListItem">
              <p className="debugBoxText">Gear Drop: {gearDropCrit} %</p>
            </li>
            <li className="debugBoxListItem">
              <p className="debugBoxText">
