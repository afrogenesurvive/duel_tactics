    ...
    if (type === "item") {
      ...
      switch (item.name) {
        ...
        case "moveSpeedDown":
          ...
          // console.log('ff',currentSpd2,app.players[player.number-1].speed.range[currentSpd2]);
          // console.log('ff2',currentSpd2,app.players[player.number-1].speed.range[currentSpd2-1]);
          if (player.speed.move > 0.05) {
