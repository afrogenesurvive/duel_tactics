...
export function drawGridInit(app, canvas, context, canvas2, context2) {
  ...
  app.popupImageRef = {
    ...
    attacking1: app.attackxIndicateRef.current,
    attacking2: app.attack3IndicateRef.current,
    ...
    attacked1: app.attackxIndicateRef.current,
    attacked2: app.attack3IndicateRef.current,
