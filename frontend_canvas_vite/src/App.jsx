...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.updateSettingsFormPlayerData = (...args) =>
      updateSettingsFormPlayerData(this, ...args);
    ...
    this.settingsFormGridWidthUpdate = (...args) =>
      settingsFormGridWidthUpdate(this, ...args);
    this.redrawSettingsGrid = (...args) => redrawSettingsGrid(this, ...args);
    this.getCustomPlyrStartPosList = (...args) =>
      getCustomPlyrStartPosList(this, ...args);
