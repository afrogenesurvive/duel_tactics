export const playerDataArray = [
  ...
  },
  {
    ...
    attacking: {
      ...
      execute: false,
      effectivenessAllowance: 10, // max = 5 || limit - peak / 2 (??) - allows for some leniency in timing for parrying projectiles and attacks. only applies when player is armed and attacking.
    },
    defending: {
      state: false,
      count: 0,
