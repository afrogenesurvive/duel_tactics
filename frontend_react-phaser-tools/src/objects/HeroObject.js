...
export default class HeroObject extends Phaser.GameObjects.Sprite {
    constructor(scene, x, y, borderOffset, floorGraphicHeight) {
        ...
        this.heroMapTile= undefined;//hero tile values in array explicitly defined out of levelData
        this.heroSpeed = 1.2;//well, speed of our hero
        this.heroMapPos= undefined;//2D coordinates of hero map marker sprite in minimap, assume this is mid point of graphic
